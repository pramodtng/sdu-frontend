...
export async function getBlogsById(id) {
  const data = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_URL}/blogs/${id}?populate=*`)
            ...
            <div className="lg:w-8/12">
              <div>
                  ...
                  <div className="flex flex-wrap items-center">
                    <div className="mr-10 mb-5 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="https://img.freepik.com/free-vector/old-library-interior-composition-with-human-character-bearded-man-reading-book-table_1284-54511.jpg?size=626&ext=jpg"
                            alt="author"
                            fill
                          />
                        </div>
                    ...
                    <div className="mb-5 flex items-center">
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        ...
                        {dayjs(data.data.attributes.publishedAt).format("LL")}
                      </p>
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        <span className="mr-3">
                          <svg
                ...
                <div>
                  ...
                  <di className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    <ReactMarkdown
