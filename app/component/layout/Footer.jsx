...
const Footer = () => {
  ...
  return (
      ...
      <div className="container max-w-7xl mx-auto px-2">
        <div className="grid lg:grid-cols-[1fr_1fr_1fr_1fr] grid-cols-1 lg:gap-5 gap-2">
          <div className='text-left'>
            <h3 className="text-blue text-3xl font-bold font-poppins mb-3"><span>{text}</span>
              <Cursor cursorColor='#027bc1' /></h3>
            <p className=' text-gray-700'>We are a Software Development Unit based IT company in Thimphu who provides top quality service.</p>
          </div>
    ...
    <div className='pt-4 pb-4 bg-gray-100'>
        <p className="text-center font-medium">&copy; {new Date().getFullYear()}. All Rights Reserved by <span className='text-sky-700'>SDU</span></p>
      </div>
      </>
  )
}
